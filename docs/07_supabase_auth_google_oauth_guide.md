...
หน้า Login ไม่มีแท็บแยก "บุคลากร / นักศึกษา" อีกต่อไป ทุกคนกดปุ่มเดียวคือ **เข้าสู่ระบบด้วยอีเมล (Google)**
และช่องกรอกเลขบัตรประชาชนถูกถอดออกจากหน้าจอทั้งหมด เลขบัตรจึงไม่ถูกพิมพ์เข้าเบราว์เซอร์อีกเลย
