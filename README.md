...
ทุกบทบาทเข้าสู่ระบบด้วยอีเมลผ่าน Google ทางเดียวกัน ไม่มีแท็บแยกบุคลากร/นักศึกษา และไม่มีการกรอกเลขบัตรประชาชนในหน้าจออีกต่อไป สิทธิ์มาจากรายชื่อที่ลงทะเบียนไว้ล่วงหน้า (`pending_staff` สำหรับบุคลากร, `students.email` สำหรับนักศึกษา) ไม่ใช่จากหน้าจอที่ผู้ใช้เลือก
